...
if($users)
{
    ...
    if (!empty($aErreur)) // Si le tableau n'est pas vide
    {
        ...
        header("Location:../Controller/recuperation_mdp.php?".$sUrl); // On affiche les erreurs dans le formulaire formulaire.php
    ...
    <div class='container'>
        ...
        <div class='row'>
            <div class='col-12'>
           <a href='http://localhost:8080/barbeuc/Controller/new_mdp.php?email=$recup_mail'>Veuillez cliquer ici pour réinitialiser votre mot de passe</a>
            </div>    
        </div>   
    </div> 
