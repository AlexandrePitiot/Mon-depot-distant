...
<form class="col-lg-12" action="../Controller/produits_modif_script.php" method="post" enctype="multipart/form-data">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="libelle" value ="<?=$produit->libelleProduit?>" id="libelle">  
</div>
