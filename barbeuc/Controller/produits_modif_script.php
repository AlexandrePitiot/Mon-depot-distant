...
$extension = substr (strrchr ($_FILES['fichier']['tmp_name'], "."), 1);
$nouveauNom = $_POST['pro_id'].'.'.$extension;

$pdoStat = $pdo->prepare("UPDATE produits SET pro_ref=:pro_ref, pro_cat_id=:pro_cat_id, libelleProduit=:libelleProduit, pro_description=:pro_description, 
...
if($InsertIsOk){
    ...
    header("Location: ../View/tableau.php"); // Si le produit a bien été ajouté, il y a une redirection vers le tableau.php
