...
<form class="col-lg-12" action="../Controller/produits_ajout_script.php" method="post" enctype="multipart/form-data">
...
<!-- Script jQuery -->
<script src="../assets/jquery/ajout_script.js"></script>