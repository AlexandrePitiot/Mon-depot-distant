...
if (!empty($aErreur)) // Si le tableau n'est pas vide
{
    ...
    header("Location:../Controller/new_mdp.php?".$sUrl); // On affiche les erreurs dans le formulaire formulaire.php
...
$pdoStat = $pdo->prepare("UPDATE users SET mdp='".$passwordHash."' WHERE mail='".$recup_mail."'");
