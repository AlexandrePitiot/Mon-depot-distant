...
?>
                    ...
                    <div class="card bg-dark mt-5 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <form action="../Model/process.php" method="post">
                                ...
                                <p style= "color: white; font-size: 14px">Mot de passe perdu ?<a href="../Controller/recuperation_mdp.php">Cliquez ici</a></p>
        ...
        <h5 class="text-center"><a href="../Controller/inscription.php" style= "color: #4169FE; text-decoration: underline">Inscrivez-vous</a></h5></br>    
