<?php
include("../View/entete.php"); // Inclure l'en-tête dans le fichier tableau.php
...
require "../Model/connexion_bdd.php"; // Inclusion de notre bibiothèque de fonctions
...
?>
    <tr>
    <td><img src ="../assets/images/jarditou_photos/<?= $row->pro_id . "." . $row->pro_photo?>" width= "100" height= "auto" class="text-center align-middle"></td>
    <td class="text-center align-middle"><?= $row->pro_id ?> </td>
    <td class="text-center align-middle"> <?= $row->pro_ref ?></td>
    <td class="text-center align-middle"><a href="../View/detail.php?pro_id=<?= $row->pro_id ?>" title="libelle" id="link_dark" style= "color: #4169FE; text-decoration: underline" > <?= $row->libelleProduit ?> </a></td>
...
<a href="../Controller/produits_ajout.php?pro_id=<?= $produit->pro_id?>" class="btn btn-primary m-0">Ajouter</a>

    <!-- FOOTER -->

<?php
include("../View/pieddepage.php"); // Inclure le pied de page dans le fichier tableau.php
?>
