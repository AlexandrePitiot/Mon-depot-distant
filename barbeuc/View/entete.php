...
<div class="container">
    ...
    <!-- Ecran moyen : 5 colonnes et Ecran large : 4 colonnes -->
        ...
        <img src="../assets/images/jarditou_logo.jpg" class="img-fluid" alt="Logo jarditou" title="Logo jarditou">
        </div>
...
<nav class="row navbar-expand-sm">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent15">
      ...
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="../View/accueil.php">Accueil <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../View/tableau.php">Tableau</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../View/formulaire.php">Contact</a>
        </li>
        <?php
        if(isset($_SESSION["Admin"]))
        {
            ?>
            <li class="nav-item">
            <a class="nav-link" href="Controller/produits_ajout.php">Ajouter un produit</a></li>
            <?php
        }
        ?>
      </ul>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../Model/deconnexion.php?logout">Déconnexion</a>
        </li>
      </ul>
    ...
    <div class="row">
    <img src="../assets/images/promotion.jpg" id="image" alt="Promotion sur les lames de terrasse" title="Promotion sur les lames de terrasse">
    </div>